...
TENSORBOARD_BASEDIR = "../tensorboard"
...
def parse_args():
    ...
    parser.add_argument(
        ...
        "-mo",
        nargs="+",
        help="Merge attributes into the YAML config file",
    )
...
def main():
    ...
    exp = Experiment(
        args.exp_name,
        args,
        exps_basedir=EXPS_BASEDIR,
        tensorboard_dir=TENSORBOARD_BASEDIR,
        mode=args.mode,
    )
    if args.cfg is None:
        ...
        cfg_path = args.cfg
    cfg = Config(cfg_path, args.merge_options)
